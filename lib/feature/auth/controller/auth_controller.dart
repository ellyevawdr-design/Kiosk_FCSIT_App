...
import 'package:networkclan_kiosk_fcsit_app/core/repositoty/storage_repository.dart';
...
class AuthController extends AsyncNotifier<AsyncValue<void>> {
  ...
  void updateUser(BuildContext context, File image, String username) async {
